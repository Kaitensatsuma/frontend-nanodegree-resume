...
var HTMLbitbucket = '<li class="flex-item"><span class="orange-text">Bitbucket</span><span class="white-text">%data%</span></li>';
...
var internationalizeButton = '<button onclick= "intNational()">Internationalize</button>';
